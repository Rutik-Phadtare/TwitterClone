    ...
    <html lang="en" className={`${syne.variable} ${dmSans.variable}`}>
      <head>
        ...
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="" />
         <link
          href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;0,9..40,800;1,9..40,300&family=Syne:wght@400;600;700;800&display=swap"
          rel="stylesheet"
        />
 
        {/* ── Preconnect to your backend & Cloudinary for faster API/image calls ── */}
        <link rel="preconnect" href="https://res.cloudinary.com" />
        <link rel="dns-prefetch" href="https://em-content.zobj.net" />
